...
export default function ClinicTimings() {
    return (
        <section className="w-full relative" id="timings">
            <div className="bg-white rounded-5xl p-8 md:p-16 grid lg:grid-cols-2 gap-16 items-center border border-slate-100 shadow-2xl shadow-primary-900/5 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="bg-gradient-to-br from-primary-50 to-white rounded-3xl p-6 border border-primary-100 flex items-start gap-5 mb-8 shadow-sm">
                        ...
                        <div>
                            <h4 className="font-bold text-secondary mb-2 text-lg">Clinic Address</h4>
                ...
                {/* Right Side Schedule */}
                <div className="relative z-10 bg-slate-50 rounded-3xl p-8 md:p-10 border border-slate-100 shadow-inner">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between items-center py-5 border-b border-slate-200/60 group">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-bold text-secondary text-lg">Monday - Friday</span>
                            </div>
                            <div className="text-right">
                                <span className="block text-secondary font-bold bg-white px-3 py-1 rounded-lg border border-slate-100 shadow-sm mb-1">09:00 AM - 01:00 PM</span>
                                <span className="block text-secondary font-bold bg-white px-3 py-1 rounded-lg border border-slate-100 shadow-sm">04:00 PM - 08:00 PM</span>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center py-5 border-b border-slate-200/60 group">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-bold text-secondary text-lg">Saturday</span>
                            </div>
                            <div className="text-right">
                                <span className="block text-secondary font-bold bg-white px-3 py-1 rounded-lg border border-slate-100 shadow-sm">09:00 AM - 02:00 PM</span>
                        ...
                        <div className="flex justify-between items-center py-5 group">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-bold text-secondary text-lg">Sunday</span>
                            </div>
