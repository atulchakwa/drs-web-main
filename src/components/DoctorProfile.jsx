...
export default function DoctorProfile() {
    return (
        <section className="w-full mx-auto px-4 md:px-8 py-20 relative overflow-hidden" id="doctor-profile">
            ...
            <div className="absolute top-1/2 left-0 -translate-y-1/2 w-96 h-96 bg-primary-50/50 rounded-full blur-3xl -z-10"></div>

            <div className="bg-white rounded-5xl p-8 md:p-16 border border-slate-100 shadow-2xl shadow-primary-900/5 flex flex-col lg:flex-row items-center gap-16 relative overflow-hidden">

                {/* Internal accent gradient */}
                <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-primary-50 to-accent-50 rounded-bl-full opacity-60"></div>
                ...
                >
                    <div className="relative w-64 h-64 md:w-96 md:h-96 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary-900/10 border-8 border-white group">
                        ...
                        >
                            ...
                            <div>
                                <p className="text-xs font-bold text-secondary">Board Certified</p>
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8 self-center lg:self-start border border-primary-100 bg-primary-50 shadow-sm text-primary-600">
                        <Activity className="w-4 h-4" />
                        <span className="text-xs font-black uppercase tracking-widest">Medical Director</span>
                    </div>

                    <h2 className="text-4xl md:text-5xl font-black mb-4 text-secondary tracking-tight">Dr. Rajesh Sharma</h2>
                    <p className="text-xl text-primary-600 font-bold mb-8">MD Internal Medicine • Post-Graduate from AIIMS</p>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 pt-8 border-t border-slate-100">
                        ...
                        <div className="flex flex-col items-center lg:items-start group">
                            <div className="w-12 h-12 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform group-hover:bg-primary-50 group-hover:text-primary-600">
                                <Star className="w-6 h-6 text-slate-400 group-hover:text-primary-600 transition-colors" />
                            </div>
                            <p className="text-3xl font-black text-secondary mb-1">15+</p>
                        ...
                        <div className="flex flex-col items-center lg:items-start group">
                            ...
                            <p className="text-3xl font-black text-secondary mb-1">10k+</p>
                        ...
                        <div className="flex flex-col items-center lg:items-start group col-span-2 md:col-span-1">
                            <div className="w-12 h-12 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform group-hover:bg-primary-50 group-hover:text-primary-600">
                                <Award className="w-6 h-6 text-slate-400 group-hover:text-primary-600 transition-colors" />
                            </div>
                            <p className="text-3xl font-black text-secondary mb-1">4.9/5</p>
